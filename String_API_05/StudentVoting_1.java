...
public class StudentVoting_1 {
    ...
    public static int[] generateAges(int n) {
        ...
        int[] ages = new int[n];
        for (int i = 0; i < n; i++) {
            ages[i] = rand.nextInt(90) + 10; // Generates age from 10 to 99
        }
        return ages;
    }
    ...
    public static String[][] votingEligibility(int[] ages) {
        ...
        for (int i = 0; i < ages.length; i++) {
            ...
            if (ages[i] < 0) result[i][1] = "Invalid Age";
    ...
    public static void main(String[] args) {
        ...
        String[][] votingData = votingEligibility(ages);
